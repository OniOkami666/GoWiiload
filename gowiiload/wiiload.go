...
func WiiloadGrabIP() (string, error) { // Looks for the WII environment variable and returns the ip as a string
...
func WiiloadConnect(ip, path string) error {
	...
	if err := wiiload_send(conn, data, buffer.Bytes()); err != nil {
		return err
	}
